...
const Main = () => {
  ...
  return (
    <div className='mainCont'>
      ...
      {servicesList.error && <div>Возникла ошибка: {servicesList.error}. Обновите страницу.</div>}
      {servicesList.services?.length ? servicesList.services.map(e => 
        <NavLink to={`/RA_SAGA_workspace-front/item/${e.id}`} state={{id: e.id}} className="serviceCont" key={e.id}>
